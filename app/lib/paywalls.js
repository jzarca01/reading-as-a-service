// https://github.com/MostlyEmre/HN-Paywall-Archiver/blob/main/paywallList.js
...
const createPaywallArray = () => {
    return Object.values(paywallSites);
};

const paywallArray = createPaywallArray();
